@echo off
REM WhatsApp Automation - Dry Run Script for Windows
REM Tests the automation without actually sending messages

echo ============================================
echo WhatsApp Automation - Dry Run Mode
echo ============================================
echo.
echo This will test the automation WITHOUT sending
echo any actual messages.
echo.
...
echo This will show what messages would be sent.
echo.
echo Press Ctrl+C to stop
echo.

REM Run the application in dry-run mode
...
echo ============================================
echo.
echo No messages were actually sent.
echo Review the output above to verify your messages.
echo.
echo To send messages for real, run: run.bat
echo.
pause
